...
const POOL_CONTRACT_ID =
  "CCHVVL26PYRYRJR4OXEEAHNHMP6OAPEJT26EZRZXVDYL3HWHCD5SEDON";
...
export const TOKEN_ID =
  "CDNZ44UBKS56UG4SKDZ656T4A23EJDX2ZCTKIYNA25KGD33GS2GCLQFH";
// Blend Testnet USDC
export const BLEND_TOKEN_ID =
...
export const soroban = {
  ...
  async getXlmPrice(): Promise<PriceData> {
    ...
    if (!contentType.includes("application/json")) {
      throw new Error(
        "Backend returned non-JSON response (ngrok interstitial?)",
      );
    }
  ...
  async createZmokeTrustline(buyerAddress: string): Promise<string> {
    const {
      ...
      Operation,
      Horizon,
      TransactionBuilder: ClassicBuilder,
