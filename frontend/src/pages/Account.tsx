...
export const Account = ({ publicKey }: AccountProps) => {
  const [activeTab, setActiveTab] = useState<"overview" | "wallet" | "history">(
    "wallet",
  );
  ...
  const handleRedeem = async () => {
    ...
    try {
      ...
      const txHash = await soroban.burnZmokeForCredit(
        publicKey,
        amount.toString(),
        TREASURY_ADDRESS,
      );
      ...
      setRedeemMessage(
        `Successfully redeemed ${amount} ZMOKE for $${(amount * ZMOKE_TO_USD_RATE).toFixed(2)} store credit!`,
      );
      setRedeemAmount("");
    } catch (e: unknown) {
        ...
        {activeTab === "overview" && (
          <div className="p-6 space-y-4">
            ...
            <div className="p-4 bg-slate-800/50 rounded-xl">
              ...
              <p className="font-mono text-sm text-emerald-400 mt-1 break-all">
                {publicKey}
              </p>
            </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/30 rounded-xl p-6 border border-purple-700/50">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-purple-400 bg-purple-900/50 px-2 py-1 rounded-full">
                  ≈ ${(parseFloat(zmokeBalance) * ZMOKE_TO_USD_RATE).toFixed(2)}{" "}
                  USD
                </span>
              </div>
            ...
            <div className="bg-slate-800/50 rounded-xl p-6">
              ...
              <p className="text-sm text-slate-400 mb-4">
                Convert your ZMOKE tokens to store credit at a rate of{" "}
                <strong className="text-emerald-400">10 ZMOKE = $1.00</strong>
              </p>
            ...
            <div className="p-4 bg-slate-800/30 rounded-xl border border-slate-700/50 text-sm text-slate-400">
              ...
              <ol className="list-decimal list-inside space-y-1 text-xs">
                ...
                <li>
                  Your ZMOKE is burned and store credit is added to your account
                </li>
