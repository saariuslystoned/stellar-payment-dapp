 ...
 */
export const SecretKeyModal = ({ publicKey, secretKey, onClose }: SecretKeyModalProps) => {
            ...
            <div className="w-full max-w-md bg-gradient-to-b from-indigo-950 to-slate-950 rounded-2xl border border-purple-900/50 shadow-2xl shadow-purple-500/10 animate-in fade-in zoom-in-95 duration-300">
                ...
                <div className="p-6 text-center border-b border-purple-900/30">
                    ...
                    <p className="text-slate-400 text-sm mt-2">
                        Save your secret key securely. <span className="text-red-400 font-semibold">You will only see this once.</span>
                    </p>
                </div>
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <button
                            ...
                            className={`w-full mt-2 py-3 rounded-lg font-bold text-sm transition-all ${copied
                    ...
                    <div className="bg-red-950/30 border border-dashed border-red-700/50 rounded-lg p-3">
                        <p className="text-red-300 text-xs leading-relaxed">
                            <strong>⚠️ IMPORTANT:</strong> This secret key controls your wallet and all your ZMOKE tokens.
                            Store it in a password manager or other secure location. <strong>We cannot recover it if lost.</strong>
                        </p>
                    </div>
                    ...
                    <label className="flex items-start gap-3 cursor-pointer group">
                        ...
                        <span className="text-slate-300 text-sm leading-snug group-hover:text-white transition-colors">
                            I have securely saved my secret key and understand it cannot be recovered.
                        </span>
                    </label>
                </div>
                ...
                <div className="p-6 pt-0">
                    <button
                        onClick={onClose}
                        disabled={!confirmed}
                        className={`w-full py-4 rounded-xl font-bold transition-all ${confirmed
